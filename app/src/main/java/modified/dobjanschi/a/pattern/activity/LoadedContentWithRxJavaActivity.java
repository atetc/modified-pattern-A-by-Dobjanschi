 ...
 * @author Rustem
 */
public class LoadedContentWithRxJavaActivity extends AppCompatActivity {

    private TextView textView;

    public static void start(Activity activity) {
        ActivityCompat.startActivity(activity, new Intent(activity, LoadedContentWithRxJavaActivity.class), null);
    }
